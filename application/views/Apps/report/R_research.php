...
<html lang="en">
    <head>
        ...
        <title>Pengajuan Izin Cuti Riset</title>

    </head>
    <body style="font-family: 'Titillium Web', sans-serif;">
        <center><br><br><br><br><br>
            <h4 style="font-family: 'Titillium Web', sans-serif;"><b>FORMULIR CUTI RISET<b></h4><br><br><br><br><br>
        </center>
        ...
        <table class="">
            ...
            <tr>
                ...
                <td >: <b><?=$get_data->type_research_id ?></b></td>
            </tr>
            <tr>
                <td >Selama</td>
