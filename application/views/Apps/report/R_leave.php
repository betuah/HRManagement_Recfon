...
<html lang="en">
    ...
    <body style="font-family: 'Titillium Web', sans-serif;">
        <center><br><br><br><br><br>
            <h4 style="font-family: 'Titillium Web', sans-serif;"><b>FORMULIR CUTI<b></h4><br><br><br><br><br>
        </center>
        ...
        <table class="">
            ...
            <tr>
                ...
                <td >: <b><?=$get_data->nama_jen_cut ?></b></td>
            </tr>
            <tr>
                <td >Selama</td>
        ...
        <div class="row">
            <div class="col-xs-12">
                <table class="">
                    ...
                    <tr>
                        <td><b><?=$get_data->nama_supervisor ?></b></td>
                    </tr>
                    <tr>
                ...
                <table class="table">
                    <tr>
                        <td colspan="2">Jakarta, 
                            <?php 
                                $tgl    = date_create($get_data->tgl_cuti);
                    ...
                    <tr>
                        <td>( <?=$get_data->nama_user ?> )</td>
                        <td class="text-right">( <?=$get_data->nama_supervisor ?> )</td>
                    </tr>
                </table>
            </div>
        </div>
