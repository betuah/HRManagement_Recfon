    ...
    <div class="col-xs-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="text-dark"><?php echo $this->session->bahasa === 'EN' ? 'Remaining Day(s) for <b class="text-maroon" >Leave</b> (This Year)' : 'Sisa Hari <b class="text-maroon" >Cuti</b> (Tahun Ini)' ?></h3>
            </div>
            <div class="box-body">
                    ...
                    <table id="tbl_remaining_days" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Quota</th>
                                <th><?php echo $this->session->bahasa === 'EN' ? 'Reamaining Days' : 'Sisa Hari' ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($get_r_days as $get) { ?>
                                <?php foreach ($qty as $getqty) { ?>
                                    <?php if($get->id_jen_cuti === $getqty->id) { $count = $get->quota - $getqty->qty ?>
                                        <tr>
                                            <td><?=$this->session->bahasa === 'ID' ? $get->nama_jen_cut : $get->nama_jen_cut_en ?></td>
                                            <td><b><?=$get->quota ?></b> <?php echo $this->session->bahasa === 'EN' ? 'Days' : 'Hari' ?></td>
                                            <td>
                                                <b class="text-maroon"><?=$count ?></b> <?php echo $this->session->bahasa === 'EN' ? 'Days' : 'Hari' ?>
                                            </td>
                                        </tr>
                                    <?php }?>
                                <?php }?>
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="text-dark"><?php echo $this->session->bahasa === 'EN' ? 'History Of Leave the office <b class="text-maroon" >(Research)</b>' : 'Riwayat Dinas <b class="text-maroon" >Riset</b>' ?></h3>
            </div>
            <div class="box-body">
                <div class="col-sm-12" id="tb_content_research">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="<?=$ndate ?>">
                                            <?=$ndate ?> ( <b class="text-maroon"><?=$get->lama_hari ?> <?php echo $this->session->bahasa === 'EN' ? 'Days' : 'Hari' ?> </b>)
                                        </span>
                                    </td>
                                    <td><?=$get->nama_plt ?></td>
                                    <td>
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="text-dark"><?php echo $this->session->bahasa === 'EN' ? 'History Of Leave the office <b class="text-maroon" >(General)</b>' : 'Riwayat <b class="text-maroon" >Dinas Umum</b>' ?></h3>
            </div>
            <div class="box-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($get->lampiran != null || $get->lampiran != '') { ?>
                                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="View Attachment File">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="text-dark"><?php echo $this->session->bahasa === 'EN' ? 'History Of <b class="text-maroon" >Overtime</b>' : 'Riwayat <b class="text-maroon" >Lembur</b>' ?></h3>
            </div>
            <div class="box-body">
                        ...
                        <tbody>
                            <?php foreach ($get_overtime as $get) { ?>
                                ...
                                <tr>
                                    <td><?=$sdate ?></td>
                                    <td><b class="text-maroon"><?=$get->nama ?></b></td>
                                    <td><?=$date ?> <b class="text-maroon">(<?=$get->time_start ?> - <?=$get->time_end ?>)</b><b class="pull-right"></b><small class="label pull-right bg-purple"><?=$time[0] ?> <?php echo $this->session->bahasa === 'EN' ? 'Hours' : 'Jam'?>, <?php echo $min = isset($time[1]) ? $time[1] : 0 ?> <?php echo $this->session->bahasa === 'EN' ? 'Minutes' : 'Menit'?></small></td>
                                    <td>
                                        <span class="pull-right-container">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="text-dark"><?php echo $this->session->bahasa === 'EN' ? 'History Of <b class="text-maroon" >Leave</b>' : 'Riwayat <b class="text-maroon" >Cuti</b>' ?></h3>
            </div>
            <div class="box-body">
                ...
                <form id="leave_form" enctype="multipart/form-data" class="form-horizontal">
                    <div id="style" class="row">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="input-group col-sm-9">
                                <input type="text" class="form-control" name="plt_edit" value="" id="plt_edit" placeholder="Count of Leave Day" readonly required>
                ...
                <div class="modal-body">
                    <div id="style" class="row">
                        ...
                        <div class="form-group col-sm-12">
                            <label for="count_day" class="col-sm-3 control-label text-dark">PLT</label>
                            <div class="input-group col-sm-9">
                                <input type="text" class="form-control" name="plt_edit" value="" id="plt_edit_general" placeholder="Count of Leave Day" readonly required>
                                <span class="input-group-addon"><i class="mdi mdi-face mdi-lg text-teal"></i></span>
                            </div>
                        </div>
                        <div class="form-group col-sm-12"> 
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if (data.code === true) {
                    ...
                    $('#plt_edit').val(get.nama_plt).trigger('change');;
